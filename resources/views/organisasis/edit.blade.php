...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Organisasi</div>
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_organisasi" class="form-control" placeholder="Nama Organisasi" value="{{ $organisasi->nama_organisasi }}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ruangan" class="form-control" placeholder="Ruangan" value="{{ $organisasi->ruangan }}">
                                    @error('ruangan')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kordinator" class="form-control" placeholder="Nama Kordinator" value="{{ $organisasi->nama_kordinator }}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Hari:</strong>
                                    <input type="date" name="tanggal" class="form-control" placeholder="Tanggal" value="{{ $organisasi->tanggal }}">
                                    @error('tanggal')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td><input type="text" name="jabatan' + no + '" class="form-control"' + data.jabatan + '"></td>' +
